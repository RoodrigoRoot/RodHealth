...
class Appoiments(models.Model):
    ...
    doctor = models.ForeignKey("accounts.Doctor", verbose_name=("Doctor"), on_delete=models.CASCADE)
    patient = models.ForeignKey("accounts.Patient", verbose_name=("Paciente"), on_delete=models.CASCADE)
